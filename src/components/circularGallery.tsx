...
class App {
  ...
  onTouchMove(e: MouseEvent | TouchEvent) {
    ...
    // Increased sensitivity for better mobile swipe responsiveness:
    const distance = (this.start - x) * 0.05; // Increased from 0.035 for better mobile response
